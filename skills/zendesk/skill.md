...
>
> **⚠️ Enforcement / changes since 2026-02-19:**
> - **OAuth token TTL enforcement (live 2026-02-02):** global (external) OAuth clients now have default token expiration and must use the refresh-token flow. Long-lived tokens without a refresh path will start failing.
